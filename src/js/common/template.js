  ...
  return `
      <div class="d-flex justify-center mt-5">
        <div class="w-100">
          ...
          <section class="lotto-status-section mt-9"></section>
...
const originalTemplate = () => {
  ...
  <div class="d-flex justify-center mt-5">
        <div class="w-100">
          <section class="lotto-purchase-section">
            <h1 class="text-center">🎱 행운의 로또</h1>
            <form class="lotto-purchase-form mt-5">
              <label class="mb-2 d-inline-block">구입할 금액을 입력해주세요. </label>
              <div class="d-flex">
          ...
          <section class="lotto-status-section mt-9">
            <div class="d-flex">
              <label class="flex-auto my-0">총 5개를 구매하였습니다.</label>
              <div class="flex-auto d-flex justify-end pr-1">
                <label class="switch">
          ...
          <form class="lotto-result-form mt-9">
            <label class="flex-auto d-inline-block mb-3">지난 주 당첨번호 6개와 보너스 넘버 1개를 입력해주세요.</label>
            <div class="d-flex">
              <div>
                <h4 class="mt-0 mb-3 text-center">당첨 번호</h4>
